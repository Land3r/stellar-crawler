...
const RoutesCmpt = ({ RouteSecureCmpt = RouteSecure }: TRoutesCmpt) => (
  <Suspense fallback={<Loader mode={MODES.get} classModifier="fullscreen" message="Chargement de la page..." />}>
    <Routes>
      ...
      <Route index path={ROUTE_URLS.NODES} element={<Nodes />} />
      <Route index path={ROUTE_URLS.NODE} element={<NodeDetail />} />
      <Route index path={ROUTE_URLS.SETTINGS} element={<Settings />} />
